...
export function PrognoseDialog({
  ...
  const handleSave = async () => {
    ...
    setIsSaving(true);
    try {
      // The customer picks installment vs. one-time on the payment portal, so
      // we no longer pre-decide here. Defaults stay safe (1 / 0).
      ...
      <DialogContent className="bg-card border-border max-w-md">
        ...
        <div className="space-y-4 py-4">
          ...
          <p className="text-xs text-muted-foreground">
            Der Kunde entscheidet im Zahlungsportal selbst zwischen Einmalzahlung und Ratenzahlung.
          </p>
        </div>
